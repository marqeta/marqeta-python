...
class TestUsersLookUp(unittest.TestCase):
    ...
    def test_look_up_success_dda(self):
        ...
        search_options = {
            'dda': user.deposit_account.account_number
        }
    ...
    def test_look_up_success_first_name(self):
        ...
        self.assertEqual(results[0].first_name, first_name,
                         'Results contain incorrect search value')
    ...
    def test_look_up_success_last_name(self):
        ...
        self.assertEqual(results[0].last_name, last_name,
                         'Results contain incorrect search value')
