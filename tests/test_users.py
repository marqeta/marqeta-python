...
list_users = client.users.list( limit = 10)
...
print("page method for users ", client.users.page()['data'][0].first_name)
...
#print("loookkkkkkk",client.users.look_up(lookup_data, params = options))

print("LOOOOKUPPP",client.users.look_up(lookup_data)[10].first_name)


# To check for Children, Notes and Transitions of Users

print("***SSN of a user****",(client.users('bluebird_token').ssn().ssn))
print("***SSN of a user with no SSN ****",client.users('f9d1c568-9ff5-4570-9e0c-3268b3488633').ssn())
