...
print("CardProduct List",client.card_products.list())
...
print("create for mechant",client.cards.create_for_merchant('017fa821-9210-4fc7-a514-86bcc7dcc08a',
                                                            {'card_product_token':client.card_products.create(card_product_data).token}))

print("Card Find",client.cards.find("mytestcard01"))

print("Find by Pan",client.cards.find_show_pan("mytestcard01"))
print("Find by Barcode",client.cards.find_by_barcode("17469201908992951865"))
...
print("make default", client.funding_sources('paycard_fs4_01').make_default())
