...
class TestGpaOrdersFind(unittest.TestCase):
    """Tests for the gpa_orders.find endpoint."""
    ...
    def test_gpa_orders_find_payment_card_user(self):
        ...
        found = self.client.gpa_orders.find(order.token)

        self.verify_gpa_order(found, order.__dict__)

    def test_gpa_orders_find_ach_user(self):
        """Finds a gpa order funded by a user ach."""
    ...
    def test_gpa_orders_find_program_user(self):
        """Finds a gpa order funded by a user program."""
