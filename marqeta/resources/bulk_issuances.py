"""BULKISSUANCES RESOURCE WITH CRU PARAMETERS"""
...
class BulkIssuancesCollection(object):
    ...
    def create(self, data, params=None):
        ...
        :param params: query parameters
        :return: BulkIssuanceResponse object of the created bulkissuances
        """
    ...
    def find(self, token, params=None):
        """
        Finds the existing bulkissuances
        :param token: bulkissuances token to find
        :param params: query parameters
        :return: BulkIssuanceResponse object
        """
    ...
    def __repr__(self):
        return "<Marqeta.resources.bulk_issuances.BulkIssuancesCollection>"
