...
from marqeta.response_models.push_to_card_disbursement_response import (
...
class PushToCardsCollection(object):
    ...
    def __init__(self, client):
        ...
        """
        self.client = client
        self.collections_pushtocards = Collection(
            self.client, PushtocardsPaymentcardCollection
        )
...
class PushtocardsDisburseCollection(object):
    ...
    def __init__(self, client):
        ...
        """
        self.client = client
        self.collections_disburse = Collection(
            self.client, PushToCardDisbursementResponse
        )
    ...
    def page(self, count=5, start_index=0, params=None):
        ...
        page 'data'field
        """
        return self.collections_disburse.page(
    ...
    def stream(self, params=None):
        ...
        """
        return self.collections_disburse.stream(
            endpoint=self._endpoint, query_params=params
        )
    ...
    def list(self, params=None, limit=None):
        ...
        """
        return self.collections_disburse.list(
    ...
    def create(self, data, params=None):
        ...
        :return: PushToCardDisbursementResponse object
        """
        return self.collections_disburse.create(
    ...
    def find(self, token, params=None):
        ...
        :return: PushToCardDisbursementResponse object
        """
        return self.collections_disburse.find(
    ...
    def save(self, token, data):
        ...
        :return: PushToCardDisbursementResponse object
        """
        return self.collections_disburse.save(
