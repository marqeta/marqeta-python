...
class MccGroupsCollection(object):
    ...
    def create(self, data, params=None):
        ...
        :param params: query parameters
        :return: MccGroupModel object of the created mccgroups
        '''
        return self.collections.create(endpoint=self._endpoint, query_params=params, data=data)
    def find(self, token, params=None):
        '''
        Finds the existing mccgroups
        :param token: mccgroups token to find
        :param params: query parameters
        :return: MccGroupModel object
        '''
    ...
    def save(self, token, data):
        '''
        Updates the existing mccgroups  data
        :param token: mccgroups token to update
        :param data: data to be updated
        :return:  MccGroupModel object of the updated  mccgroups
        '''
        return self.collections.save(data, endpoint=self._endpoint + '/{}'.format(token))
    def __repr__(self):
        return '<Marqeta.resources.mcc_groups.MccGroupsCollection>'
