...
from marqeta.response_models.chargeback_transition_response import (
...
class ChargebacksContext(ChargebacksCollection):
    ...
    def grant_provisional_credit(self):
        return self.client.put(
            "chargebacks/{}/grantprovisionalcredit".format(self.token), data={}
        )[0]

    def reverse_provisional_credit(self):
        return self.client.put(
            "chargebacks/{}/reverseprovisionalcredit".format(self.token), data={}
        )[0]
    ...
    class Transitions(object):
        ...
        def create(self, data):
            return self.collection.create(
                data, endpoint=self._endpoint + "/transitions"
            )
