...
'''PROGRAMTRANSFERS RESOURCE WITH CRU PARAMETERS'''
...
class ProgramTransfersCollection(object):
    ...
    def __init__(self, client):
        ...
        self.types = ProgramTransfersTypes(Collection(client, ProgramTransferTypeReponse))
...
class ProgramTransfersTypes(object):
    ''' class to specify sub endpoints for programtransfers '''
    ...
    def page(self, count=5, start_index=0, params=None):
        return self.collection.page(endpoint=self._endpoint, count=count, start_index=start_index,
                                    query_params=params)
    ...
    def list(self, params=None, limit=None):
        return self.collection.list(endpoint=self._endpoint, query_params=params, limit=limit)
    ...
    def __repr__(self):
        return '<Marqeta.resources.programtransfers.ProgramTransfersTypes>'
