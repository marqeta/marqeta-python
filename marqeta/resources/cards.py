...
class CardsCollection(object):
    ...
    def find_show_pan(self, card_token, params=None):
        ...
        """
        return self.collections.find(
            endpoint=self._endpoint + "/{}/showpan".format(card_token),
            query_params=params,
        )
    ...
    def find_by_barcode(self, barcode, params=None):
        ...
        """
        return self.collections.find(
            endpoint=self._endpoint + "/barcode/{}".format(barcode), query_params=params
        )
    ...
    def find_for_merchant(self, token, params=None):
        ...
        """
        return self.collections.find(
            endpoint=self._endpoint + "/merchant/{}".format(token), query_params=params
        )
    ...
    def find_for_merchant_show_pan(self, token, params=None):
        ...
        """
        return self.collections.find(
            endpoint=self._endpoint + "/merchant/{}/showpan".format(token),
            query_params=params,
        )
    ...
    def create_for_merchant(self, token, data):
        ...
        """
        return self.collections.create(
            endpoint=self._endpoint + "/merchant/{}".format(token), data=data
        )
    ...
    def tokens_for_pan(self, pan_token):
        ...
        """
        pan = {"pan": pan_token}
        return self.collections_pan_response.create(
            endpoint=self._endpoint + "/getbypan", data=pan
        )
...
class CardsContext(CardsCollection):
    ...
    def __init__(self, token, client):
        ...
        self.transitions = self.Transitions(
            self.token, Collection(client, CardTransitionResponse)
        )
