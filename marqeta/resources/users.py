...
class UsersCollection(object):
    ...
    def page(self, params=None):
        return self.collections_cardmodel.page(endpoint=self._endpoint, query_params=params)
...
class UserContext(UsersCollection):
    ...
    class Children(object):
        ...
        def stream(self, params=None):
            return self.collection.stream(endpoint='users/{}/children'.format(self.token), query_params=params)
    ...
    class Transitions(object):
        ...
        def page(self, params=None):
            return self.collection.page(endpoint=self._endpoint + '/user/{}'.format(self.token), query_params=params)

        def stream(self, params=None):
            return self.collection.stream(endpoint=self._endpoint + '/user/{}'.format(self.token), query_params=params)
